...
```bash
curl http://localhost:3000/api/environment/presets
```
...
3. **磁盘空间不足**: 完整安装需要 5-10GB 空间
4. **脚本执行失败**: 查看 stderr 输出获取详细错误信息
...
详细的 API 文档请参考：
- [环境管理 API](docs/ENVIRONMENT_API.md)
- [在线 Swagger 文档](http://localhost:3000/docs)
...
- Author: games.gong <games.gong@pbn.com.cn>
